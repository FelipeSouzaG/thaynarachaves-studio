...
const API_URL =
  'https://script.google.com/macros/s/AKfycbwlPc30PEbKqclpdkwzWzVNvIV4ntmTibGwaMpniq4bQcvaBO1DmNiA-_nYJu40berb3Q/exec';
const BOT_TOKEN = '7781855843:AAFkVqzRHJC8vJyA0OagtjWys7HAAOKii-g';
const CHAT_ID = '6952821431';
const PHONE_ADMIN = '5531995454632';
...
export async function appointmentDay(dateSelected) {
  ...
  try {
    ...
    if (horarios.length === 0) {
      container.innerHTML =
        '<label class="label">Nenhum horário disponível para esta data.</label>';
      return;
    }
...
async function appointmentTime(horario, data) {
  ...
  document.getElementById('submit').addEventListener('click', async () => {
    ...
    formData.append('telefone', formatPhoneValue(phone));
    formData.append('procedimento', procedimento.value);
    ...
    try {
      ...
      try {
        ...
        console.warn('Erro ao enviar para Telegram:', error);
